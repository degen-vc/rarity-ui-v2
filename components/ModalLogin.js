						...
						<div className={'inline-block align-bottom bg-white text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full md:mb-96 font-mono'}>
							<div className={'p-6 space-y-4'}>
								<div
									...
									className={'bg-white hover:shadow-sm hover:bg-gray-principal cursor-pointer border-4 border-solid border-black dark:border-dark-100 flex flex-col justify-center items-center transition-colors p-6 text-center'}>
