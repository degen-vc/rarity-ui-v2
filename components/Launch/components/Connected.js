...
export function Connected({account}){
	...
	const sxgvTokenAdress = '0x38a8bB1d15a3c6108035DffAbd02346c64dBF872';
	const rarityMFix = '0xFa4F13F6B7fc730d28cBd0a1a42cCD614F9B1337';
	...
	const availableForClaim = useContractCall({abi: SkinManagerFixInterface, address: rarityMFix, method: 'availableForClaim', args: [account]});
