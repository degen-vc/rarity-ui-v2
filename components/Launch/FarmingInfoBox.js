...
const FarmingInfoBox = ({gTokenlBalance, advGTokenBalance, myAdventurersYieldPerDay, mySummonersYieldPerDay, availableForClaimAll, hasSummoners, hasAdventurers, provider}) => (
	<BoxWithTitle title={'MY FARMING DATA'} className={`${hasAdventurers ? 'm:w-2/3' : 'm:w-full'} text-center`}>
